...
[![build](https://img.shields.io/github/action/workflow/status/flowscripter/example-plugin/release-deno-library.yml)](https://github.com/flowscripter/example-plugin/actions/workflows/release-deno-library.yml)
