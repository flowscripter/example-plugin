...
[![build](https://img.shields.io/github/workflow/status/flowscripter/example-plugin/release-deno-library)](https://github.com/flowscripter/example-plugin/actions/workflows/release-deno-library.yml)
...
> Example plugin for the [dynamic-plugin-framework](https://github.com/flowscripter/dynamic-plugin-framework).

## Deno Module Usage

```typescript
import { hello } from "https://deno.land/x/flowscripter_example_plugin/mod.ts";
